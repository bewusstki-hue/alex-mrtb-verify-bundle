#!/usr/bin/env bash
# Beweist zwei unabhaengige Dinge zu PR #36 von alex-controlled-agent-demo,
...
curl -sO https://bewusstki.de/downloads/verify-bundle/demo-pr-36.json
...
BASE=$(node -e "console.log(require('./demo-pr-36.json').controller_evidence.repository_state.base_commit)")
RESULT=$(node -e "console.log(require('./demo-pr-36.json').controller_evidence.repository_state.result_commit)")
...
echo "PR ansehen: https://github.com/Alex-Proof/alex-controlled-agent-demo/pull/36"
